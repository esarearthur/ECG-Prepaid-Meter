...
void GSM3ShieldV1DataNetworkProvider::attachGPRSContinue()
{
	...
	else if(ct==2)
	{
		if(theGSM3ShieldV1ModemCore.genericParse_rsp(resp))
	    {
			if(resp)
			{
				...
				theGSM3ShieldV1ModemCore.genericCommand_rq(PSTR("AT+CIPSHUT"));
	...
	{
		//prepareAuxLocate(PSTR("+CGACT: 1,0"), auxLocate1);
		//prepareAuxLocate(PSTR("+CGACT: 2,0"), auxLocate2);
		if(theGSM3ShieldV1ModemCore.genericParse_rsp(resp))
	    {
			if(resp)
			{
				...
				theGSM3ShieldV1ModemCore.genericCommand_rq(PSTR("AT+CIPMUX=0"));				
	...
	else if(ct==4)
	{
		if(theGSM3ShieldV1ModemCore.genericParse_rsp(resp))
	    {
			if(resp)
			{
				...
				theGSM3ShieldV1ModemCore.genericCommand_rq(PSTR("AT+CIPSTATUS"));
	...
	else if(ct==6)
	{
		if(theGSM3ShieldV1ModemCore.genericParse_rsp(resp))
	    {
			if(resp)
			{
				...
				theGSM3ShieldV1ModemCore.genericCommand_rq(PSTR("AT+CGACT=1,1"));
	...
	else if(ct==8)
	{
		if(theGSM3ShieldV1ModemCore.genericParse_rsp(resp))
	    {
			if(resp)
			{
				...
				theGSM3ShieldV1ModemCore.genericCommand_rq(PSTR("AT+CGATT=1"));
	...
	else if(ct==10)
	{
		if(theGSM3ShieldV1ModemCore.genericParse_rsp(resp))
	    {
			if (resp) 
				{
					theGSM3ShieldV1ModemCore.genericCommand_rq(PSTR("AT+CSTT"));
	...
	else if(ct==12)
	{
		if(theGSM3ShieldV1ModemCore.genericParse_rsp(resp))
		{
			if (resp)
			{
				theGSM3ShieldV1ModemCore.genericCommand_rq(PSTR("AT+CIICR"));
				theGSM3ShieldV1ModemCore.setCommandCounter(13);
			}
			else theGSM3ShieldV1ModemCore.closeCommand(3);
		}
	}
	else if(ct==13)
	{
		if(theGSM3ShieldV1ModemCore.genericParse_rsp(resp))
		{
			if (resp)
			{
				theGSM3ShieldV1ModemCore.genericCommand_rq(PSTR("AT+CIFSR"));
				theGSM3ShieldV1ModemCore.setCommandCounter(14);
			}
			else theGSM3ShieldV1ModemCore.closeCommand(3);
		}
	}
	...
	{
		prepareAuxLocate(PSTR("."), auxLocate1);
